        ...
        <div className="flex-center">
          <div className="grid grid-cols-1 md:grid-cols-3 bg-[#F2EFDF] mt-10 gap-20 p-10 rounded-md">
            <div className="w-[300px] text-center flex-center flex-col gap-5">
              ...
              <img
                src="/assets/images/aulas-mensais/cursomensal.jpg"
                alt="aula"
            ...
            <div className="w-[300px] text-center flex-center flex-col gap-5">
              ...
              <img
                src="/assets/images/aulas-mensais/cursomensal2.jpg"
                alt="aula"
                className="w-[300px] rounded-sm"
              />
              <div className="bg-[#0D0D0D] w-full flex flex-col text-center rounded-md">
            ...
            <div className="w-[300px] text-center flex-center flex-col gap-5">
              ...
              <img
                src="/assets/images/aulas-mensais/cursomensal3.jpg"
                alt="aula"
                className="w-[300px] rounded-sm"
              />
              <div className="bg-[#0D0D0D] w-full flex flex-col text-center rounded-md">
            ...
            <div className="w-[300px] text-center flex-center flex-col gap-5">
              ...
              <img
                src="/assets/images/aulas-mensais/cursomensal4.jpg"
                alt="aula"
                className="w-[300px] rounded-sm"
              />
            ...
            <div className="w-[300px] text-center flex-center flex-col gap-5">
              ...
              <img
                src="/assets/images/aulas-mensais/cursomensal5.jpg"
                alt="aula"
                className="w-[300px] rounded-sm"
              />
              <div className="bg-[#0D0D0D] w-full flex flex-col text-center rounded-md">
