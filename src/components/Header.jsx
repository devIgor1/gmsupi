...
const Header = () => {
  return (
    <header className="w-full bg-gradient-to-br from-yellow-900 to-yellow-700">
      <nav className="wrapper flex-between font-lora bg-gradient-to-br from-slate-50 to-slate-300 bg-clip-text text-transparent">
        ...
        <div className="text-lg md:text-2xl font-bold flex-between gap-6">
          <a href="#">Inicio</a>
          <div className="flex-between">
            <a href="#">Cursos</a>
            <span>
              <MdOutlineArrowDropDown size={35} color="#fff" />
            </span>
          </div>
        </div>
      </nav>
