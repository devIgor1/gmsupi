          ...
          <div className="w-full flex-center mx-auto pt-10 flex-center flex-col p-10">
            <div className="flex-center flex-col gap-10 w-full">
              <div className="flex-col md:flex-row flex-around gap-10">
                <img
                  src="/assets/images/sobre/supisobre.jpg"
                  alt="supi-sobre"
              ...
              <div className="flex-col md:flex-row flex-center">
                <img
                  src="/assets/images/noticias-supi/noticiasupi.png"
                  alt=""
                  className="w-[300px] md:w-full h-[200px] rounded-tl-md md:rounded-bl-md rounded-tr-md md:rounded-tr-none"
                />
                <img
                  src="/assets/images/noticias-supi/noticiasupi2.jpg"
                  alt=""
                  className="w-[300px] md:w-full h-[200px]"
                />
                <img
                  src="/assets/images/noticias-supi/noticiasupi3.jpg"
                  alt=""
                  className="w-[300px] md:w-full h-[200px]"
                />
                <img
                  src="/assets/images/noticias-supi/noticiasupi4.jpg"
                  alt=""
                  className="w-[300px] md:w-full h-[200px]"
                />
                <img
                  src="/assets/images/noticias-supi/noticiasupi5.png"
                  alt=""
                  className="w-[300px] md:w-full h-[200px]"
                />
                <img
                  src="/assets/images/noticias-supi/noticiasupi6.png"
                  alt=""
