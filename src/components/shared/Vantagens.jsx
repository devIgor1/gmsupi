      ...
      <div className="flex-center flex-col">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-10 max-w-[1350px]">
          <div className="flex-center flex-col rounded-lg p-5 border-2 border-black bg-[#efebd8]">
            <img
              src="/assets/images/metodosupi.jpg"
              alt="metodosupi.jpg"
          ...
          <div className="flex-center flex-col rounded-lg p-5 border-2 border-black bg-[#efebd8]">
            <img
              src="/assets/images/metodojulia.jpg"
              alt="metodosupi.jpg"
              className="w-[350px] rounded-lg "
            />
            <div className="mt-5 text-center bg-[#0D0D0D] p-5 rounded-md">
            ...
            <div className="flex-center">
              <div className="grid grid-cols-1 md:grid-cols-3 mt-10 gap-10 bg-[#efebd8] border-2 border-black p-5 rounded-lg">
                <div className="max-w-[300px]">
                  <img
                    src="/assets/images/profsupi.jpg"
                    alt="profsupi.jpg"
                ...
                <div className="max-w-[300px]">
                  <img
                    src="/assets/images/profjulia.jpg"
                    alt="profsupi.jpg"
                    className="rounded-md w-[300px]"
                  />
                  <div className="p-3 rounded-b-lg flex-center gap-4">
                ...
                <div className="max-w-[300px]">
                  <img
                    src="/assets/images/proffelipe.jpg"
                    alt="profsupi.jpg"
                    className="rounded-md w-[300px]"
                  />
                  <div className="p-3 rounded-b-lg flex-center gap-4">
                ...
                <div className="max-w-[300px]">
                  <img
                    src="/assets/images/profalvaro.jpg"
                    alt="profsupi.jpg"
                ...
                <div className="max-w-[300px]">
                  <img
                    src="/assets/images/proffier.jpg"
                    alt="profsupi.jpg"
                    className="rounded-md w-[300px]"
                  />
                  <div className="p-3 rounded-b-lg flex-center gap-4">
                ...
                <div className="max-w-[300px]">
                  <img
                    src="/assets/images/profvictor.jpg"
                    alt="profsupi.jpg"
                    className="rounded-md w-[300px]"
                  />
                  <div className="p-3 rounded-b-lg flex-center gap-4">
